...
class Db {
     ...
     * @example <pre>
     * Core::$db['db1']->select('SEL_all','hotvideo',false,false,'dateline desc,id desc',1,false,true)
     * Core::$db['db1']->select('id,title','hotvideo','review>:rev',false,'dateline desc,id desc',10,array('rev'=>10),false)
     * </pre>
     */
